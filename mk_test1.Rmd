...
rD <- rsDriver(port=4723L, chromever="113.0.5672.63")
remDr <- rD$client
...
### 미국 투자대가들의 종목별 순매수 규모(**Action Date at `r recent_date`**)
...
### 미국 투자대가들의 종목별 매수강도(순매수 주식수/상장 주식수)(**Action Date at `r recent_date`**)
...
names(result) <- c("Ticker","Name","Industry","buy/sell shares(thou)_A", "total shares(thou)_B","A/B")
